...
class AlarmGroupRepository(context: Context) {
    private val prefs = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)

    fun loadGroups(): List<AlarmGroup> {
    ...
    fun saveGroups(groups: List<AlarmGroup>) {
        val array = JSONArray()
    ...
    companion object {
        ...
        private const val KEY_GROUPS = "alarm_groups"
    }
}
